...
- [IMPORTANT FIRST (one small adjustment)](#important-first-one-small-adjustment)
- [GOAL](#goal)
- [STEP 1: Open Windows Task Scheduler](#step-1-open-windows-task-scheduler)
- [STEP 2: Create a New Task](#step-2-create-a-new-task)
- [STEP 3: Enter Windows Password](#step-3-enter-windows-password)
- [STEP 4: TEST IT](#step-4-test-it)
- [HOW IT WILL WORK DAILY](#how-it-will-work-daily)
- [IMPORTANT REALITY CHECK (honesty)](#important-reality-check-honesty)
- [DISCIPLINE AUTOMATED](#discipline-automated)
